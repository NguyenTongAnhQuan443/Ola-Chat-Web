...
export default function InviteList() {
  ...
  const getListRequest = async () => {
    try {
      ...
      console.log('Loi khi lay danh sach yeu cau ket ban', err)
    } finally {
      setIsLoading(false)
    }
  }
    ...
    <div className='friend-invites'>
      ...
      {isLoading && (
        <div className='text-center py-3'>
          ...
          <p className='mt-2'>Đang tải danh sách lời mời...</p>
        </div>
      )}
                  ...
                  <div className='col-12 col-md-6 mb-3' key={request.requestId}>
                    <div className='bg-white rounded shadow-sm p-3'>
                      ...
                      <div className='d-flex'>
                        <button
                          className='btn btn-light flex-grow-1 me-2'
